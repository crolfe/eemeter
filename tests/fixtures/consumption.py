...
def consumption_generator_1(request):
    ...
    generator = MonthlyBillingConsumptionGenerator(
        fuel_type, consumption_unit_name, temperature_unit_name, model, params)
...
def generated_consumption_data_with_annualized_usage_1(
        request, generated_consumption_data_1):
...
@pytest.fixture
def generated_consumption_data_pre_post_1(
        request,
        generated_consumption_data_1,
        generated_consumption_data_2):
...
def generated_consumption_data_pre_post_with_gross_savings_1(
...
def generated_consumption_data_with_hdd_1(
...
def generated_consumption_data_with_cdd_1(
        request, gsod_722880_2012_2014_weather_source):
