...
class AverageDailyTemperatureSensitivityModel(Model):
    ...
    def __init__(self, heating, cooling, *args, **kwargs):
        if cooling:
            ...
            if heating:
                self.model = AverageDailyBaseloadHeatingConsumptionModel(
                    *args, **kwargs)
            else:
                self.model = AverageDailyBaseloadConsumptionModel(
                    *args, **kwargs)
...
class AverageDailyBaseloadConsumptionModel(Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(
            AverageDailyBaseloadConsumptionModel,
            self).__init__(
            *args,
            **kwargs)
...
class AverageDailyBaseloadHeatingConsumptionModel(Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(
            AverageDailyBaseloadHeatingConsumptionModel,
            self).__init__(
            *args,
            **kwargs)
    ...
    def _transform(self, X, param_array):
        ...
        for period_daily_temps in observed_daily_temps:
            ...
            daily_heating_demand = np.maximum(
                heating_balance_temperature - period_daily_temps, 0)
...
class AverageDailyBaseloadCoolingConsumptionModel(Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(
            AverageDailyBaseloadCoolingConsumptionModel,
            self).__init__(
            *args,
            **kwargs)
    ...
    def _transform(self, X, param_array):
        ...
        for period_daily_temps in observed_daily_temps:
            ...
            daily_cooling_demand = np.maximum(
                period_daily_temps - cooling_balance_temperature, 0)
...
class AverageDailyBaseloadHeatingCoolingConsumptionModel(Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(
            AverageDailyBaseloadHeatingCoolingConsumptionModel,
            self).__init__(
            *args,
            **kwargs)
    ...
    def _transform(self, X, param_array):
        ...
        for period_daily_temps in observed_daily_temps:
            ...
            avg_daily_consumption_estimate = avg_daily_cooling_consumption + \
                avg_daily_heating_consumption + base_daily_consumption
